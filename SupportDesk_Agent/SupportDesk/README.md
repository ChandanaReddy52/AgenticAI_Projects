...
powered by Claude (Anthropic) for ticket intelligence and DevRev-style
...
> AI features (ticket analysis, insights, chat) require an Anthropic API key.
...
4. **AI Chat on Ticket Detail** — conversational Q&A with full ticket + related-ticket context
...
*"Which customer should I call first?"* are answered with full awareness of all tickets
and customer health scores.

This architecture is exactly how DevRev Computer works: structured enterprise data
